...
namespace lucy\LucyMail\Helper;

use Magento\Store\Model\Store;

class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    const XML_PATH_ACTIVE           = 'LucyMail/general/active';
    const XML_PATH_APIKEY           = 'LucyMail/general/apikey';
    const XML_PATH_MAXLISTAMOUNT    = 'LucyMail/general/maxlistamount';
    const XML_PATH_LIST             = 'LucyMail/general/list';
    const XML_PATH_LOG              = 'LucyMail/general/log';
    const XML_PATH_MAPPING          = 'LucyMail/general/mapping';
     ...
     * @param \lucy\LucyMail\Model\Logger\Logger $logger
     * @param \Magento\Customer\Model\GroupRegistry $groupRegistry
     */
    public function __construct(
        \Magento\Framework\App\Helper\Context $context,
        \Magento\Store\Model\StoreManagerInterface $storeManager,
        \lucy\LucyMail\Model\Logger\Logger $logger,
