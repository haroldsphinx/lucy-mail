...
namespace lucy\LucyMail\Test\Unit\Helper;
...
class DataTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected $_helper;
    /**
     * @var \lucy\LucyMail\Model\Logger\LucyMail|\PHPUnit_Framework_MockObject_MockObject
     */
    protected $_logger;
    ...
    protected function setUp()
    {
        ...
        $storeManagerMock = $this->getMockBuilder('Magento\Store\Model\StoreManagerInterface')
            ->disableOriginalConstructor()
            ->getMock();
        $this->_logger = $this->getMockBuilder('lucy\LucyMail\Model\Logger\Logger')
            ->disableOriginalConstructor()
            ->getMock();
...
//        $billingMock->expects($this->any())->method('getCompany')->willReturn('lucy');
